...
import type { shapeProps } from '@/types/canvasTypes'

const ShapeOptions = ({ tool, colorShape, setColorShape, setFillStyle, fillStyle, setTool }: shapeProps) => {
  const disableEslint = () => {}
  return (
    <>
      <div
        className={`${tool === 'rectangle' || tool === 'circle' || tool === 'triangle' ? '-top-10' : 'top-0'}
  flex gap-2 items-center text-white h-10 w-[90%]  p-2 absolute -z-10  duration-300 ease-in-out rounded-t-lg left-1/2 -translate-x-1/2 bg-black border-x-[1px] border-t-[1px] border-gray-500`}
      >
        <svg
          ...
          className={`${fillStyle ? 'hover:scale-110' : 'bg-blue-500 scale-110'} cursor-pointer  duration-150 rounded `}
        >
          <title>image</title>
          <path
            fillRule="evenodd"
        ...
        <svg
          ...
          viewBox="0 0 20 20"
          xmlns="http://www.w3.org/2000/svg"
          className={`${fillStyle ? 'bg-blue-500 scale-110' : 'hover:scale-110'} cursor-pointer  duration-150 rounded `}
        >
          <title>image</title>
          <path
            fillRule="evenodd"
        ...
        <svg
          ...
          fill="none"
          xmlns="http://www.w3.org/2000/svg"
          className={`${tool === 'rectangle' ? 'bg-blue-500 scale-110' : 'hover:scale-110'} cursor-pointer  duration-150 rounded`}
        >
          <title>image</title>
          <path
            fillRule="evenodd"
        ...
        <svg
          ...
          fill="none"
          xmlns="http://www.w3.org/2000/svg"
          className={`${tool === 'circle' ? 'bg-blue-500 scale-110' : 'hover:scale-110'} cursor-pointer  duration-150 rounded`}
        >
          <title>image</title>
          <path
            fillRule="evenodd"
        ...
        <svg
          ...
          fill="none"
          xmlns="http://www.w3.org/2000/svg"
          className={`${tool === 'triangle' ? 'bg-blue-500 scale-110' : 'hover:scale-110'} cursor-pointer  duration-150 rounded`}
        >
          <title>image</title>
          <path
            fillRule="evenodd"
